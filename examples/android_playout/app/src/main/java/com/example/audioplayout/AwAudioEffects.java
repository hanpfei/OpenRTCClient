...
public class AwAudioEffects {
    private static final boolean DEBUG = false;

    private static final String TAG = "AwAudioEffects";
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        List<String> blackListedModels = AwAudioUtils.getBlackListedModelsForAecUsage();
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        List<String> blackListedModels = AwAudioUtils.getBlackListedModelsForNsUsage();
        boolean isBlacklisted = blackListedModels.contains(Build.MODEL);
        if (isBlacklisted) {
    ...
    public static boolean canUseAcousticEchoCanceler() {
        boolean canUseAcousticEchoCanceler = isAcousticEchoCancelerSupported()
                && !AwAudioUtils.useWebRtcBasedAcousticEchoCanceler()
    ...
    public static boolean canUseNoiseSuppressor() {
        boolean canUseNoiseSuppressor = isNoiseSuppressorSupported()
                && !AwAudioUtils.useWebRtcBasedNoiseSuppressor() && !isNoiseSuppressorBlacklisted()
                && !isNoiseSuppressorExcludedByUUID();
        Logging.d(TAG, "canUseNoiseSuppressor: " + canUseNoiseSuppressor);
        return canUseNoiseSuppressor;
    }

    public static AwAudioEffects create() {
        return new AwAudioEffects();
    }

    private AwAudioEffects() {
