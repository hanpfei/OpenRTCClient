...
#include "include/audio_device_defines.h"
#include "utility/helpers_android.h"
...
public:
  ...
  public:
    ...
    bool StartPlayout();
    bool StopPlayout();
    bool SetStreamType(int streamType);
  ...
  int SetSpeakerStreamType(int streamType);
  ...
  void SetDataCallback(AudioPlayerDataCallback *data_callback);
...
//  AudioDeviceBuffer* audio_device_buffer_;
  AudioPlayerDataCallback* audio_data_callback_;
};
