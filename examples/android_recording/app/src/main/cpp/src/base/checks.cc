...
#define RTC_LOG_TAG_ANDROID "awaudio"
...
RTC_NORETURN void rtc_FatalMessage(const char* file,
                                   ...
                                   const char* msg) {
#if RTC_CHECK_MSG_ENABLED
  static constexpr awaudio::webrtc_checks_impl::CheckArgType t[] = {
      awaudio::webrtc_checks_impl::CheckArgType::kEnd};
  awaudio::webrtc_checks_impl::FatalLog(file, line, msg, t);
#else
